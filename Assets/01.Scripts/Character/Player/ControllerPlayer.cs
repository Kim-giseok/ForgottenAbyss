...
public class ControllerPlayer : MonoBehaviour
{
    ...
    //{
    //    if (value.isPressed && !isAttacking && currentJumpCount < jumplimit) //���� ���� ����
    //        if (isGround)
    //        {
    //            rigid.velocity = new Vector2(rigid.velocity.x, 0); // y�� �ӵ� �ʱ�ȭ
    ...
    //public void OnAttack(InputValue value) //�Ϲݰ��� Ű �Է�
    //{
    ...
    //void OnFirstSkill() //1����ų Ű �Է�
    //{
    //    Debug.Log("S: ��ų1");
    //}

    //void OnSecondSkill() //2����ų Ű �Է�
    //{
    //    Debug.Log("D: ��ų2");
    //}

    //void OnSpecialSkill() //Ư����ų Ű �Է�
    //{
    //    Debug.Log("R: Ư�� ��ų");
    //}
    ...
    public void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        //    }
        //}
        //else if (isIgnoringCollision) //�ٸ� ��ü�� �浹 �� ���� ���� ����
        //{
        //    StartCoroutine(IgnorePlatformCollision(false));
        //    isIgnoringCollision = false;
        //}
    ...
    //    Vector2 dashDirection = new Vector2(inputVec.x, 0); //���� �̵� ����
    ...
    //    rigid.velocity = new Vector2(inputVec.x * speed, rigid.velocity.y); //���� �ӵ��� ����
    //}
    ...
    //public IEnumerator IgnorePlatformCollision(bool ignore) //�÷��� �ݶ��̴� ����
    //{
    ...
    //public IEnumerator ResetIgnoreCollision(float delay) //�ݶ��̴� ���� ���� �ʱ�ȭ
    //{
